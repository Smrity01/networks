...
def lost_allframe(frame1, frame2, frame3, Rframe1, Rframe2, Rframe3, counter):
    for i in range(1, 67):
        ...
        if (i == 37):
            canvas.delete(frame3)
            canvas.update()
    timeout = canvas.create_text(450, 250, text="Timeout..! As First frame is lost other were discarded",
...
def last_frame(frame1, frame2, frame3, Rframe1, Rframe2, Rframe3, counter):
    for i in range(1, 67):
        ...
        if (i == 33):
            canvas.delete(frame3)
            canvas.update()
    timeout = canvas.create_text(450, 250, text="Timeout..! As last frame is lost, slide the window until this frame",
                                 font="Times 15 italic bold")
    canvas.update()
    time.sleep(2)
    canvas.delete(timeout)
...
# return
# ............................................................exceptional cases........................................
# .......................when less than window size frame are left at the end....................
# exceptional case
# to send 1 frames
def sendone_frame(frame1,Rframe1, counter):
    for i in range(1, 67):
        if (i % 2 == 0):
            counter = counter + 1
            canvas.itemconfig(timer, text=counter)
...
def draw_canvas(counter):
    ...
    time.sleep(1)
    lost_allframe(frame4,frame5,frame6,Rframe4,Rframe5,Rframe6,counter)
    frame4 = draw_frame(50, 120, 170, 'red')
    frame5 = draw_frame(50, 120, 225, 'red')
    frame6 = draw_frame(50, 120, 280, 'red')

    time.sleep(1)
    last_frame(frame4,frame5,frame6,Rframe4,Rframe5,Rframe6,counter)
    frame6 = draw_frame(50,120,280,'red')
    lost_secondframe(frame6,frame7,frame8,Rframe6,Rframe7,Rframe8,counter)
    ...
    move_frame(frame7,frame8,frame9,Rframe7,Rframe8,Rframe9,counter)
